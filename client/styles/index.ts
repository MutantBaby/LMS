export const styles = {
  ...
  button:
    "font-semibold font-poppins !text-white !dark:text-black text-[16px] w-full min-h-[45px] !bg-[#2490ff] cursor-pointer !rounded-full px-6 py-3 items-center justify-center flex flex-row ",
};
